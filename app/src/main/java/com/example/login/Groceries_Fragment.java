...
public class Groceries_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        get_Fragment = inflater.inflate(R.layout.fragment_groceries_, container, false);
        expandableListView = get_Fragment.findViewById(R.id.expandableListView_Gro);

        ArrayList<Products> tempList= Listdata_fruits.getProductsByCatId(getContext(),2);
        expandableList_Details =Listdata_fruits.getData(getContext(),tempList, 2);
